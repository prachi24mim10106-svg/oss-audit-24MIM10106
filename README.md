...
## Student Details
- **Name:** Prachi Khatri
- **Roll Number:** 24MIM10106
- **Course:** Open Source Software (OSS)
- **Software:** MySQL

## Project Overview
This project is an open-source audit of MySQL, here we study its origin, GPL licensing, how it works with Linux, and its ecosystem. It includes five shell scripts that show the practical use of Linux and open-source concepts in a simple way.

MySQL is one of the most popular open-source database systems. It's a great example to understand how open-source software works, how Linux is used in real-life applications. This project helps in understanding important ideas like sharing, flexibility in open-source technology.
...
## Conclusion
This project helps in gaining a better understanding of open-source software using MySQL.It also improves practical knowledge of Linux commands. By this project, we can know how open-source tools are actually used in real-world systems and applications.
